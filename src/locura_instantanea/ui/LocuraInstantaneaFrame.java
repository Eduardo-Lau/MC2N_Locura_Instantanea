...
import locura_instantanea.persistence.EstadoPartidaDTO;
import locura_instantanea.persistence.GestorPersistencia;
 ...
 * @author carlo
 */
public class LocuraInstantaneaFrame extends javax.swing.JFrame implements Serializable {

    public static Cubo Cubo1 = new Cubo();
    public static Cubo Cubo2 = new Cubo();
    public static Cubo Cubo3 = new Cubo();
    public static Cubo Cubo4 = new Cubo();
    ...
    // Binarios
    public static EstadoPartidaDTO Cubo1Bin = new EstadoPartidaDTO();
    public static EstadoPartidaDTO Cubo2Bin = new EstadoPartidaDTO();
    public static EstadoPartidaDTO Cubo3Bin = new EstadoPartidaDTO();
    public static EstadoPartidaDTO Cubo4Bin = new EstadoPartidaDTO();
    public static ArrayList<EstadoPartidaDTO> partidasBin = new ArrayList<>();
    public static EstadoPartidaDTO solucionAplicadaBin = new EstadoPartidaDTO();
    ...
    private void initComponents() {
        ...
        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/locura_instantanea/ui/fondo.png"))); // NOI18N
        ...
        fondo1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/locura_instantanea/ui/fondo.png"))); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/locura_instantanea/ui/LOCURA INSTANTÁNEA2.gif"))); // NOI18N
        ...
        checkLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/locura_instantanea/ui/check.png"))); // NOI18N
    ...
    public void BinariosOut() {
        ...
        for (int i = 0; i < iPartida; i++) {
            ...
            ArrayList<Solucion> solucionesTemp = partidas.get(i).soluciones;

            partidasBin.add(new EstadoPartidaDTO(cubo1temp, cubo2temp, cubo3temp, cubo4temp, solucion, solucionesTemp));
        ...
        GestorPersistencia.guardarCubos(Cubo1Bin, Cubo2Bin, Cubo3Bin, Cubo4Bin);
        GestorPersistencia.guardarPartidas(partidasBin, solucionAplicadaBin);

    }

    public final void BinariosIn() {

        EstadoPartidaDTO[] cubosCargados = GestorPersistencia.cargarCubos();
        if (cubosCargados != null) {
            Cubo1Bin = cubosCargados[0];
            Cubo2Bin = cubosCargados[1];
            Cubo3Bin = cubosCargados[2];
            Cubo4Bin = cubosCargados[3];
            ...
            System.out.println("Cubos.bin ha sido procesado con éxito");
        }

        Object[] partidasData = GestorPersistencia.cargarPartidas();
        if (partidasData != null) {
            partidasBin = (ArrayList<EstadoPartidaDTO>) partidasData[0];
            solucionAplicadaBin = (EstadoPartidaDTO) partidasData[1];
            ...
            for (int i = 0; i < partidasBin.size(); i++) {
                ...
                ArrayList<Solucion> solucionesTemp = partidasBin.get(i).soluciones;
    ...
    private void resolverBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resolverBtnActionPerformed
        ...
        boolean resuelta = ValidadorTorre.esTorreResuelta(
                ...
                Cubo1C5J.getBackground(), Cubo2C5J.getBackground(), Cubo3C5J.getBackground(), Cubo4C5J.getBackground(),
                Cubo1C4J.getBackground(), Cubo2C4J.getBackground(), Cubo3C4J.getBackground(), Cubo4C4J.getBackground(),
                Cubo1C6J.getBackground(), Cubo2C6J.getBackground(), Cubo3C6J.getBackground(), Cubo4C6J.getBackground()
        );
    ...
    public void resolverJuego() {
        ...
        cubos[0][0][0] = MotorGrafo.fromString(Cubo1arista1I);
        cubos[0][0][1] = MotorGrafo.fromString(Cubo1arista1F);
        cubos[0][1][0] = MotorGrafo.fromString(Cubo1arista2I);
        cubos[0][1][1] = MotorGrafo.fromString(Cubo1arista2F);
        cubos[0][2][0] = MotorGrafo.fromString(Cubo1arista3I);
        cubos[0][2][1] = MotorGrafo.fromString(Cubo1arista3F);
        
        cubos[1][0][0] = MotorGrafo.fromString(Cubo2arista1I);
        cubos[1][0][1] = MotorGrafo.fromString(Cubo2arista1F);
        cubos[1][1][0] = MotorGrafo.fromString(Cubo2arista2I);
        cubos[1][1][1] = MotorGrafo.fromString(Cubo2arista2F);
        cubos[1][2][0] = MotorGrafo.fromString(Cubo2arista3I);
        cubos[1][2][1] = MotorGrafo.fromString(Cubo2arista3F);
        
        cubos[2][0][0] = MotorGrafo.fromString(Cubo3arista1I);
        cubos[2][0][1] = MotorGrafo.fromString(Cubo3arista1F);
        cubos[2][1][0] = MotorGrafo.fromString(Cubo3arista2I);
        cubos[2][1][1] = MotorGrafo.fromString(Cubo3arista2F);
        cubos[2][2][0] = MotorGrafo.fromString(Cubo3arista3I);
        cubos[2][2][1] = MotorGrafo.fromString(Cubo3arista3F);
        
        cubos[3][0][0] = MotorGrafo.fromString(Cubo4arista1I);
        cubos[3][0][1] = MotorGrafo.fromString(Cubo4arista1F);
        cubos[3][1][0] = MotorGrafo.fromString(Cubo4arista2I);
        cubos[3][1][1] = MotorGrafo.fromString(Cubo4arista2F);
        cubos[3][2][0] = MotorGrafo.fromString(Cubo4arista3I);
        cubos[3][2][1] = MotorGrafo.fromString(Cubo4arista3F);
